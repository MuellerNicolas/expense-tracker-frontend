...
export class UebersichtService {
  ...
  getAusgabeJeKategorieAktuellerMonat(): Observable<any[]> {
    return this.httpClient
      .get<any[]>(`${this.backendAPI}/AusgabeJeKategorieAktuellerMonat/`)
      .pipe(
        catchError(
          this.serviceHelperService.handleError<any[]>(
  ...
  getAusgabeJeKategorieHalbesJahr(): Observable<any[]> {
    return this.httpClient
      .get<any[]>(`${this.backendAPI}/AusgabeJeKategorieHalbesJahr/`)
      .pipe(
        catchError(
          this.serviceHelperService.handleError<any[]>(
  ...
  getBudgetauslastungJeKategorieAktuellerMonat(): Observable<any[]> {
    return this.httpClient
      .get<any[]>(
        `${this.backendAPI}/BudgetauslastungJeKategorieAktuellerMonat/`
      )
      .pipe(
        catchError(
          this.serviceHelperService.handleError<any[]>(
